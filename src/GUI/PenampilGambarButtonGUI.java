...
public class PenampilGambarButtonGUI extends javax.swing.JFrame {

    /**
     * Creates new form PenampilGambarButtonGUI
     */
    public PenampilGambarButtonGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PenampilGambarButtonGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PenampilGambarButtonGUI().setVisible(true);
            }
        });
    }
